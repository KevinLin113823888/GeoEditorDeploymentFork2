describe('template spec', () => {
  it('passes', () => {
    ...
    cy.get('.css-wkpw2c > .MuiFormControl-root > .MuiInputBase-root > #outlined-basic').type('copy testing');
    ...
    cy.get('.css-wkpw2c > .MuiFormControl-root > .MuiInputBase-root > #outlined-basic').clear('c');
    cy.get('.css-wkpw2c > .MuiFormControl-root > .MuiInputBase-root > #outlined-basic').type('copy rename');
    cy.get('.modal-confirm-button').click();

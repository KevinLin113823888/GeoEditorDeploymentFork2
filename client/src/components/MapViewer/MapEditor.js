                        ...
                        ind2 = -1;
                            ...
                            coordinates.forEach((coordinate, subInd) => {
                                ...
                                if (removePattern === "Even" && subInd % 2 === 0) {
                                    map3.set(coordinate.toString(), true);
                                    if(map.get(coordinate.toString()).position !=="first" && map.get(coordinate.toString()).position !=="last"){
                                        if(props.file.features[featureInd2].geometry.coordinates[ind0][ind1].length>3)
        ...
        featuresCopy.forEach(feature => {
            ...
            if (feature.geometry.type === 'Polygon') {
                ...
                feature.geometry.coordinates.forEach(coordinates => {
                    ...
                    //props.file.features[featureInd2].geometry.coordinates=props.file.features[featureInd2].geometry.coordinates.filter(a=>a.length!==1)  
                ...
                feature.geometry.coordinates.forEach(polygon => {
                    ...
                    polygon.forEach(coordinates => {
                        ...
                        ind2 = -1;
                            ...
                            console.log(props.file.features[featureInd2].geometry.coordinates[ind0][ind1].length)
                            console.log(props.file.features[featureInd2].geometry.coordinates)
                            //console.log(props.file.features[featureInd2].geometry.coordinates[ind0]=props.file.features[featureInd2].geometry.coordinates[ind0].filter(a=>a.length<1))
                            //console.log(props.file.features[featureInd2].geometry.coordinates=props.file.features[featureInd2].geometry.coordinates .filter(a=>a.length<1))
                            //props.file.features[featureInd2].geometry.coordinates[ind0]=polygon.filter(a=>a.length!==1)     
